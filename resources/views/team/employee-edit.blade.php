...
<section class="main-content employee-edit-page"><div class="container py-5">
    ...
    <div class="card employee-card mx-auto mb-4" style="max-width:760px"><div class="card-body p-4 p-lg-5">
        ...
        </div><div class="d-flex mt-3"><button class="btn btn-primary ml-2">معلومات محفوظ کریں</button><a class="btn btn-outline-secondary" href="{{ route('admin.team.index') }}">واپس</a></div></form>
    </div></div>
