...
<head>
    ...
    <style>
        ...
        html[lang="ur"] h1,html[lang="ur"] h2,html[lang="ur"] h3,html[lang="ur"] h4,html[lang="ur"] h5,html[lang="ur"] h6{line-height:1.65}
        html[lang="ur"] p,html[lang="ur"] small,html[lang="ur"] .small,html[lang="ur"] .form-text{line-height:1.9}
        html[lang="ur"] .form-group>label:not(.custom-control-label),html[lang="ur"] label.form-label{display:block;line-height:1.9;min-height:1.9em;margin-bottom:.4rem!important}
        html[lang="ur"] .form-control{height:auto;min-height:48px;padding-top:.55rem;padding-bottom:.65rem;line-height:1.7}
        html[lang="ur"] textarea.form-control{height:auto;min-height:110px}
