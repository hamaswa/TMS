            ...
            <div class="card col-sm-10 mx-auto">
                ...
                <form id="cc-form__addCustomerForm" action="{{ route('admin.cloth.store') }}" class="add-customer-form"
                        ...
                        <div class="col-md-8">
                            <div class="form-row m-0">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <small class="form-text text-muted">Enter colors separated by commas (e.g.,
                                        red,blue,green).</small>
                                    @error('colors')
                    ...
                    <div class="form-group row">
                        <div class="col-md-8">
                            <div class="form-row m-0">
                                <label class="col-sm-3 col-form-label f"><span class="english">فی میٹر قیمت خرید</span>
                                </label>
                                <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <div class="col-md-8">
                            <div class="form-row m-0">
                                <label class="col-sm-3 col-form-label f"><span class="english">فی میٹر قیمت فروخت</span>
                                </label>
                                <div class="col-sm-9">
                            ...
                            <div class="col-md-8">
                                <div class="form-row m-0">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select name="image_colors[]" class="form-control" required>
