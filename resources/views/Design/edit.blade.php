    ...
    <section class="main-content">
        <div class="container">
            ...
            <div class="card col-sm-10 mx-auto">
                @include('inc.message')
                <h2 class="mb-4 text-right">ڈیزائن شامل کریں۔</h2>
                <form id="cc-form__addCustomerForm" class="add-customer-form" method="post"
                    action="{{ route('admin.design.update',['id'=>$data->id]) }}">
                    @csrf
                    <div class="form-group row">
                        <div class="col-md-8">
                            <div class="form-row m-0">
                                <label class="col-sm-3 col-form-label f"><span class="english">ڈیزائن کا نام</span>
                                </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="name[]" value="{{$data->design_name}}">
                                    @error('name')
                    ...
                    <div class="form-group row">
                        <div class="col-md-8">
                            <div class="form-row m-0">
                                <label class="col-sm-3 col-form-label f"><span class="english">ڈیزائن کی رقم</span>
                                </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="rupee[]" value="{{$data->design_price}}">
                                    @error('rupee')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
