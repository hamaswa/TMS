@extends('main')
@section('content')
<section class="main-content"><div class="container-fluid px-3 px-md-4"><div class="card"><div class="card-header"><h1 class="h4 mb-0">نیا خریداری آرڈر</h1></div><div class="card-body">
