        ...
        <form id="customer-create-form" action="{{ route('admin.Customers.store') }}" method="post">@csrf
            <section class="customer-step active" data-step="1" aria-labelledby="customer-step-one">
                <div class="customer-section"><h2 id="customer-step-one" class="h5 font-weight-bold mb-1">گاہک کی بنیادی معلومات</h2><p class="text-muted mb-4">رابطہ اور موبائل اکاؤنٹ کی معلومات درج کریں۔</p><div class="row">
                    ...
                    <div class="col-md-6 form-group"><label>رابطہ نمبر <span class="text-danger">*</span></label><input type="tel" class="form-control" name="contact" value="{{ old('contact') }}" required dir="ltr" autocomplete="tel"></div>
            ...
            <section class="customer-step" data-step="2" aria-labelledby="customer-step-two">
                <div class="customer-section"><div class="d-flex flex-wrap justify-content-between align-items-center mb-3"><div><h2 id="customer-step-two" class="h5 font-weight-bold mb-1">بنیادی پیمائش</h2><p class="text-muted mb-0">تمام پیمائش ایک ہی اکائی میں درج کریں۔</p></div><span class="badge badge-light px-3 py-2">ضروری خانے *</span></div><div class="row">
                    @foreach(['length'=>'لمبائی','arms'=>'بازو','teraa'=>'تیرا','senaChorai'=>'سینہ چوڑائی','damanchorai'=>'دامن چوڑائی','shalwar'=>'شلوار','pancha'=>'پنچا','shalwarGheer'=>'شلوار گھیر','monda'=>'مونڈا','chuta'=>'چوتا'] as $name => $label)
