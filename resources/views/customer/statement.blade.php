...
<section class="main-content customer-workspace" dir="rtl">
    <div class="container-fluid px-3 px-lg-5 py-4">
        ...
        @if($activeTab === 'measurements' && $canManageMeasurements)
            <div class="card workspace-card"><div class="card-body p-4 p-lg-5"><div class="section-heading"><div><h2 class="h4 font-weight-bold">محفوظ شدہ پیمائش</h2><p>سسٹم اور کاروبار کے اپنے اضافی پیمائشی خانے @if($customer->measurementTemplate)· ٹیمپلیٹ: <strong>{{ $customer->measurementTemplate->name }}</strong>@endif</p></div><a class="btn btn-outline-primary" href="{{ route('admin.Customers.edit', $customer) }}"><i class="fas fa-edit ml-1"></i> پیمائش تبدیل کریں</a></div>
